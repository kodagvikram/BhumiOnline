...
@TargetApi(Build.VERSION_CODES.JELLY_BEAN) @SuppressLint("NewApi") public class TriangleAreaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		b1Edittext=(EditText)findViewById(R.id.samlambbelowinput2);
		b2Editext=(EditText)findViewById(R.id.samlambbelowinput1);
...
//				startActivity(intent);
		...
		a1Edittext.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence s, int start, int before,
			  ...
			  if(!a1Edittext.getText().toString().equals("")&&!a2Edittext.getText().toString().equals("")&&!b1Edittext.getText().toString().equals("")&&!b2Editext.getText().toString().equals(""))
				{
					CalculateAreDdash();
				}//end of outer if
			}
...
//			 guntheEdittext.setText(""+strArray[0]);
	...
	public void CalculateAreDdash()
	{
		try {
			NumberFormat formatter = new DecimalFormat("#0.00");
			double temp=(((jantria*jantrib)/2))/100;	
			outputEdittext1.setText(""+formatter.format(temp));
			//outputEdittext1.setText(""+jantria+"-"+jantrib);
...
//				temp2=jantrib-jantria;
			...
			double temp3=(jantria*jantria)+(jantrib*jantrib);
...
//		} 
	...
	//**********************************************************
		    ...
		    Typeface type = Typeface.createFromAsset(TriangleAreaActivity.this.getAssets(),"fonts/calibribold.ttf");	
		    Typeface type2 = Typeface.createFromAsset(TriangleAreaActivity.this.getAssets(),"fonts/calibri.ttf");	
		    for (int i = 0; i <8; i++) {
