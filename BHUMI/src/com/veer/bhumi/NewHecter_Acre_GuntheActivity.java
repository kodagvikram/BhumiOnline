...
public class NewHecter_Acre_GuntheActivity extends Activity {
	...
	int panelWidth = 0;
	int edittextwidth=0,edittextheight=0,totalwidth=0,imageviewwidth=0,gunthewidth=0;
	EditText areEdittext,acreEdittext,guntheEdittext,hecteroutputEdittext;
	private boolean isExpanded;
	public double  totalArrayList[]=new double[11];
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.new_hecter__acre__gunthe);
		try{
		Constants.activity_stack.add(this);
		metrics = new DisplayMetrics();
		getWindowManager().getDefaultDisplay().getMetrics(metrics);
		panelWidth = (int) ((metrics.widthPixels) * 0.75);
		edittextwidth= (int) ((metrics.widthPixels) * 0.26);
		...
		gunthewidth=(int) ((metrics.widthPixels) * 0.18);
		...
		try {
			...
			backbtn.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Intent slideactivity = new Intent(getApplicationContext(), HectaretoGuntheActivity.class);
			...
			final TextView  textviewtitle2=(TextView)findViewById(R.id.HECTAREtextview5);
			  ...
			  hecteroutputEdittext=(EditText)findViewById(R.id.NEWHECTERoutput2);
...
//			});
			  ...
			  hecteroutputEdittext.addTextChangedListener(new TextWatcher() {
					...
					public void onTextChanged(CharSequence s, int start, int before,
							int count) {
						if(!hecteroutputEdittext.getText().toString().equals(""))
						{
							CalculateInverseValue(hecteroutputEdittext, acreEdittext, guntheEdittext, 11);
						}//end of if
						else
						{
...
//		} 
    ...
    for (int i = 0; i <10; i++) {
			...
			RelativeLayout.LayoutParams params2 = new RelativeLayout.LayoutParams(gunthewidth,edittextheight);
			RelativeLayout.LayoutParams params3 = new RelativeLayout.LayoutParams(imageviewwidth-20,edittextheight);
			RelativeLayout.LayoutParams params4 = new RelativeLayout.LayoutParams(edittextwidth,edittextheight);
			
			RelativeLayout.LayoutParams params5 = new RelativeLayout.LayoutParams(imageviewwidth+10,edittextheight-30);
			RelativeLayout.LayoutParams params6 = new RelativeLayout.LayoutParams(edittextwidth,edittextheight);
			RelativeLayout.LayoutParams params7 = new RelativeLayout.LayoutParams(imageviewwidth+10,edittextheight-30);
...
//			 tv1.setText("Acre");
			...
			editText4.setFilters(new InputFilter[] {new InputFilter.LengthFilter(maxLength+1)});
//			
//			final ImageView imageView3=new ImageView(this);
//			params7.addRule(RelativeLayout.RIGHT_OF,editText4.getId());
//			//params3.addRule(RelativeLayout.BELOW,tv1.getId());
//			params7.leftMargin=5;
//			params7.rightMargin=5;
//			imageView3.setId(7000+i);
//			imageView3.setImageResource(R.drawable.arrowright);
			
			
			final EditText editText1=new EditText(this);
			params1.addRule(RelativeLayout.RIGHT_OF,editText4.getId());
			editText1.setId(100+i);
			editText1.setBackgroundResource(R.drawable.roundes_edittext_border);
			editText1.setInputType(InputType.TYPE_CLASS_NUMBER);
			editText1.setFilters(new InputFilter[] {new InputFilter.LengthFilter(maxLength-2)});
...
//			params5.addRule(RelativeLayout.RIGHT_OF,editText2.getId());
//			//params3.addRule(RelativeLayout.BELOW,tv1.getId());
//			params5.leftMargin=5;
//			params5.rightMargin=5;
//			imageView2.setId(6000+i);
//			imageView2.setImageResource(R.drawable.arrowright);
            
			final EditText editText3=new EditText(this);
			params4.addRule(RelativeLayout.RIGHT_OF,editText2.getId());
			//params2.addRule(RelativeLayout.BELOW,tv2.getId());
			//params2.topMargin=5;
			...
			editText3.setFilters(new InputFilter[] {new InputFilter.LengthFilter(maxLength+1)});
...
//            
			...
			//layout.addView(imageView2, params5);
			//layout.addView(imageView3, params7);
			layout.addView(editText3, params4);
			layout.addView(editText4, params6);
...
//								}
						...
						{
							AlertDialog.Builder builder = new AlertDialog.Builder(
									NewHecter_Acre_GuntheActivity.this);
							builder.setTitle("BHUMI");
							builder.setMessage("Enter value less than 40")
									.setCancelable(false)
									.setPositiveButton("OK",
											new DialogInterface.OnClickListener() {
												public void onClick(
...
//						}
			...
			editText4.addTextChangedListener(new TextWatcher() {
				...
				public void onTextChanged(CharSequence s, int start, int before,
					...
					{
						double temp=0;
						int len=editText4.getText().toString().length();
						
						if(!Character.toString(editText4.getText().toString().charAt(len-1)).equalsIgnoreCase("."))
						 temp=Double.valueOf(editText4.getText().toString());
						
						if(temp<401)
						{
							if(!editText4.getText().toString().equals(""))
							{
								CalculateInverseValue(editText4, editText1, editText2, k);
							}//end of if
							else
							{
//								totalArrayList[k]=0;
//								double sum=0;
//								for (int m = 0; m < 10; m++) {
//									sum=sum+	totalArrayList[m];
//								}
//								hecteroutputEdittext.setText(""+sum);
						...
						else
						{
							AlertDialog.Builder builder = new AlertDialog.Builder(
									NewHecter_Acre_GuntheActivity.this);
							builder.setTitle("BHUMI");
							builder.setMessage("Enter value less than 400")
									.setCancelable(false)
									.setPositiveButton("OK",
											new DialogInterface.OnClickListener() {
												public void onClick(
...
//                        }//end of else
	...
	public void CalculateInverseValue(EditText acreEdittext,EditText guntheEdittext,EditText OutputEdittext,int pos)
	{
		try {
			...
			if(!Character.toString(acreEdittext.getText().toString().charAt(length-1)).equalsIgnoreCase("."))
			{
				...
				double temp=Double.valueOf(acreEdittext.getText().toString())*10000;
	...
	public void CalculateValue(EditText acreEdittext,EditText guntheEdittext,EditText OutputEdittext,int pos)
	{
		try {
			int length=acreEdittext.getText().toString().length();
...
//					outputstring=outputstring+"."+n;	
				...
				hecteroutputEdittext.setText(formatter2.format(sum));
