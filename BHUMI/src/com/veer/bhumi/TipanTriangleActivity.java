...
public class TipanTriangleActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.newtriangleareaxml);
		try{
		...
		c1Edittext=(EditText)findViewById(R.id.samlambinput1);
		c2Edittext=(EditText)findViewById(R.id.samlambinput2);
		outputEdittext1=(EditText)findViewById(R.id.outputedittext1);
		
		outputEdittext2=(EditText)findViewById(R.id.outputedittext1);
...
//			 guntheEdittext.setText(""+strArray[0]);
	...
	public void CalculateAreDdash()
	{
		try {
			...
			double temp=((((jantric+jantrib))*(jantria/2))/100);	
...
//		} 
    ...
    Typeface type = Typeface.createFromAsset(TipanTriangleActivity.this.getAssets(),"fonts/calibribold.ttf");	
    Typeface type2 = Typeface.createFromAsset(TipanTriangleActivity.this.getAssets(),"fonts/calibri.ttf");	
    for (int i = 0; i <8; i++) {
