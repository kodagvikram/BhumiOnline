...
public class AddnewMAZATOTALActivity extends Activity {
...
//	public double  totalArrayListc[]=new double[10];
	...
	public void onBackPressed() {
		...
		SharedPreferences.Editor editor = sharedPreferences
				.edit();
		editor.putString("newADDMAZATOTAL",""+sum);
		editor.commit();
		super.onBackPressed();
		} catch (Exception e) {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		singleton=BhumiSingleton.getInstance(AddnewMAZATOTALActivity.this);
			...
			clearbtn.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					for (int i = 0; i <10; i++) {
						...
						if(i<5)
						{
							if(singleton.newSELECTEDSIGN.equalsIgnoreCase("PLUS"))
							{
								singleton.newAarray[i]=0;
								singleton.newBarray[i]=0;
								singleton.newCarray[i]=0;
							}else if(singleton.newSELECTEDSIGN.equalsIgnoreCase("MINUS"))
							{
...
//			editText4.setInputType(InputType.TYPE_CLASS_NUMBER | InputType.TYPE_NUMBER_FLAG_DECIMAL);
			...
			editText1.addTextChangedListener(new TextWatcher() {
				...
				public void onTextChanged(CharSequence s, int start, int before,
					...
					if(!editText1.getText().toString().equals(""))
					{
						...
						{
							if(singleton.newSELECTEDSIGN.equalsIgnoreCase("PLUS"))
							singleton.newAarray[k]=temp;
							else if(singleton.newSELECTEDSIGN.equalsIgnoreCase("MINUS"))
							singleton.newminusAarray[k]=temp;
					...
					{
						if(singleton.newSELECTEDSIGN.equalsIgnoreCase("PLUS"))
							singleton.newAarray[k]=0;
							else if(singleton.newSELECTEDSIGN.equalsIgnoreCase("MINUS"))
							singleton.newminusAarray[k]=0;
					}
				}
			});//end of listner
			editText2.addTextChangedListener(new TextWatcher() {
				...
				public void onTextChanged(CharSequence s, int start, int before,
					...
					if(!editText2.getText().toString().equals(""))
					{
						...
						{
							if(singleton.newSELECTEDSIGN.equalsIgnoreCase("PLUS"))
								singleton.newBarray[k]=temp;
								else if(singleton.newSELECTEDSIGN.equalsIgnoreCase("MINUS"))
								singleton.newminusBarray[k]=temp;
							if(!editText1.getText().toString().equals("")&&!editText2.getText().toString().equals("")&&!editText3.getText().toString().equals(""))
							{
								CalculateValue(editText1, editText2, editText3,k);
							}//end of if
					...
					{
						if(singleton.newSELECTEDSIGN.equalsIgnoreCase("PLUS"))
							singleton.newBarray[k]=0;
							else if(singleton.newSELECTEDSIGN.equalsIgnoreCase("MINUS"))
							singleton.newminusBarray[k]=0;
					}
				}
			});//end of listner
			editText3.addTextChangedListener(new TextWatcher() {
				...
				public void onTextChanged(CharSequence s, int start, int before,
					...
					if(!editText3.getText().toString().equals(""))
					{
						...
						{
							if(singleton.newSELECTEDSIGN.equalsIgnoreCase("PLUS"))
								singleton.newCarray[k]=temp;
								else if(singleton.newSELECTEDSIGN.equalsIgnoreCase("MINUS"))
								singleton.newminusCarray[k]=temp;
							if(!editText1.getText().toString().equals("")&&!editText2.getText().toString().equals("")&&!editText3.getText().toString().equals(""))
							{
								CalculateValue(editText1, editText2, editText3,k);
							}//end of if
					...
					{
						if(singleton.newSELECTEDSIGN.equalsIgnoreCase("PLUS"))
							singleton.newCarray[k]=0;
						else if(singleton.newSELECTEDSIGN.equalsIgnoreCase("MINUS"))
							singleton.newminusCarray[k]=0;
					}
				}
			});//end of listner
			//final int k=i;
			if(singleton.newSELECTEDSIGN.equalsIgnoreCase("PLUS"))
			{
			if(singleton.newAarray[i]>0)
			editText1.setText(""+singleton.newAarray[i]);
			if(singleton.newBarray[i]>0)
				editText2.setText(""+singleton.newBarray[i]);
			if(singleton.newCarray[i]>0)
				editText3.setText(""+singleton.newCarray[i]);
			}
			else if(singleton.newSELECTEDSIGN.equalsIgnoreCase("MINUS"))
			{
			if(singleton.newminusAarray[i]>0)
			editText1.setText(""+singleton.newminusAarray[i]);
			if(singleton.newminusBarray[i]>0)
				editText2.setText(""+singleton.newminusBarray[i]);
			if(singleton.newminusCarray[i]>0)
				editText3.setText(""+singleton.newminusCarray[i]);
			}
