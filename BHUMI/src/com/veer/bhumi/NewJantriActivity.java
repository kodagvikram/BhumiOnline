...
public class NewJantriActivity extends Activity {
	...
	public double  totalArrayList[]=new double[25];
		...
		try {
			...
			backbtn.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Intent slideactivity = new Intent(getApplicationContext(), JantriActivity.class);
...
//		} 
    ...
    Typeface type = Typeface.createFromAsset(NewJantriActivity.this.getAssets(),"fonts/calibribold.ttf");	
    Typeface type2 = Typeface.createFromAsset(NewJantriActivity.this.getAssets(),"fonts/calibri.ttf");	
    for (int i = 0; i <25; i++) {
			...
			RelativeLayout.LayoutParams params3 = new RelativeLayout.LayoutParams(imageviewwidth-20,edittextheight-20);
			RelativeLayout.LayoutParams params4 = new RelativeLayout.LayoutParams(totalwidth,edittextheight);
			
			RelativeLayout.LayoutParams params5 = new RelativeLayout.LayoutParams(imageviewwidth+20,edittextheight);
...
//			 tv1.setText("Acre");
			...
			editText1.setFilters(new InputFilter[] {new InputFilter.LengthFilter(2)});
...
//			 tv2.setText("Gunthe");
			...
			//params3.addRule(RelativeLayout.BELOW,tv1.getId());
			params5.leftMargin=1;
			params5.rightMargin=1;
			imageView2.setId(6000+i);
			imageView2.setImageResource(R.drawable.arrowright);
            
			final EditText editText3=new EditText(this);
			params4.addRule(RelativeLayout.RIGHT_OF,imageView2.getId());
			//params2.addRule(RelativeLayout.BELOW,tv2.getId());
			//params2.topMargin=5;
	...
	public void CalculateValue(EditText acreEdittext,EditText guntheEdittext,EditText OutputEdittext,int pos)
	{
		try {
			...
			if(!Character.toString(acreEdittext.getText().toString().charAt(length-1)).equalsIgnoreCase(".")&&!Character.toString(guntheEdittext.getText().toString().charAt(length2-1)).equalsIgnoreCase("."))
			{
				...
				double temp=(Double.valueOf(acreEdittext.getText().toString())*16)+(Double.valueOf(guntheEdittext.getText().toString()));
