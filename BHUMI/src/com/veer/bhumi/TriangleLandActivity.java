...
public class TriangleLandActivity extends Activity {
...
//		} 
    ...
    Typeface type = Typeface.createFromAsset(TriangleLandActivity.this.getAssets(),"fonts/calibribold.ttf");	
    Typeface type2 = Typeface.createFromAsset(TriangleLandActivity.this.getAssets(),"fonts/calibri.ttf");	
    for (int i = 0; i <10; i++) {
...
//			 tv4.setText("Are");
	...
	public void CalculateValue(EditText a,EditText b,EditText c,EditText outputEdittext,int k)
	{
		...
		if(!Character.toString(a.getText().toString().charAt(length-1)).equalsIgnoreCase(".")&&!Character.toString(b.getText().toString().charAt(length2-1)).equalsIgnoreCase(".")&&!Character.toString(c.getText().toString().charAt(length3-1)).equalsIgnoreCase("."))
		{
			...
			outputEdittext.setText(""+formatter2.format(temp2));
			totalArrayList[k]= (Double.valueOf(Lastoutput));
			
			if(SCALESELECTED.equalsIgnoreCase("1:500"))
			{
				  String Lastoutput2=formatter.format(temp2*25);
					String[] strArray2 = Lastoutput2.split("\\.");
			outputEdittext.setText(""+formatter2.format(temp2*25));
			totalArrayList500[k]= (Double.valueOf(Lastoutput2));
			}
			else if(SCALESELECTED.equalsIgnoreCase("1:300"))
			{
				  String Lastoutput2=formatter.format(temp2*9);
				  String[] strArray2 = Lastoutput2.split("\\.");
			      outputEdittext.setText(""+formatter2.format(temp2*9));
			      totalArrayList300[k]= (Double.valueOf(Lastoutput2));
			}else if(SCALESELECTED.equalsIgnoreCase("1:2000"))
			{
				  String Lastoutput2=formatter.format(temp2*4);
				  String[] strArray2 = Lastoutput2.split("\\.");
			      outputEdittext.setText(""+formatter2.format(temp2*4));
			      totalArrayList2000[k]= (Double.valueOf(Lastoutput2));
			}else if(SCALESELECTED.equalsIgnoreCase("1:20"))
			{
				  String Lastoutput2=formatter.format(temp2*62.7264);
				  String[] strArray2 = Lastoutput2.split("\\.");
			      outputEdittext.setText(""+formatter2.format(temp2*62.7264));
			      totalArrayList20[k]= (Double.valueOf(Lastoutput2));
			}else if(SCALESELECTED.equalsIgnoreCase("1:480"))
			{
				  String Lastoutput2=formatter.format(temp2*23.04);
				  String[] strArray2 = Lastoutput2.split("\\.");
			      outputEdittext.setText(""+formatter2.format(temp2*23.04));
			      totalArrayList480[k]= (Double.valueOf(Lastoutput2));
			}else if(SCALESELECTED.equalsIgnoreCase("1:600"))
			{
				  String Lastoutput2=formatter.format(temp2*36);
				  String[] strArray2 = Lastoutput2.split("\\.");
			      outputEdittext.setText(""+formatter2.format(temp2*36));
